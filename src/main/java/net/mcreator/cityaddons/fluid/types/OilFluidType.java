...
public class OilFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("city_addons:blocks/stilloiltexture"),
					FLOWING_TEXTURE = new ResourceLocation("city_addons:blocks/flowingoiltexture");
