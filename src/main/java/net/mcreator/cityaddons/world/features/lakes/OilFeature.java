...
public class OilFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("city_addons:oil", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(CityAddonsModBlocks.OIL.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("city_addons:oil", CONFIGURED_FEATURE,
